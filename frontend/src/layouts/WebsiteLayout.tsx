      ...
      <li className="block w-full">
        ...
        >
          <div className="inline-flex items-center">
            <a href="/admin/products">Trang quản trị</a>
          </div>
        </a>
      </li>
    );
  ...
  if (temp) {
    ...
    return (
      <>
        ...
        <li
          className="cursor-pointer block w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
          onClick={dangxuat}
        >
          Đăng xuất
        </li>
    ...
    return (
      <li className="text-center p-3 hover:bg-[#cccccc]">
        <a className="block" href="/user/login">
...
const showUser = (temp: IUser) => {
  ...
  if (temp) {
    return (
      <>
        <details className="dropdown mb-32 max-md:hidden">
          <summary className="flex mt-[10px]">
            <img
              className="w-[50px] h-[50px] rounded-[50%] mr-3 cursor-pointer"
              src={temp.images}
              alt=""
            />
          </summary>
    ...
    return (
      <a
        className=" hidden md:block text-white leading-[60px]"
        href="/user/login"
      >
        Đăng nhập
      </a>
    ...
    <>
      <header className=" h-[64px]  fixed top-0 right-0 left-0 bg-[#515154] z-10 max-sm:px-[10px] max-xl:px-[20px]">
        ...
        <div className="z-20 relative hidden search-mobile">
          <div className="bg-black fixed top-0 left-0 right-0 h-[70px]  z-50 max-sm">
            <div className=" relative mx-auto text-gray-600 w-2/4 pt-[20px] max-sm:w-[80%]">
              <form action="" onSubmit={handleSearchProductByName_moblie}>
                <input
                  className="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none w-full z-40"
                  type="search"
                  id="search_moblie"
                  placeholder="Search"
                />
                <button className="absolute right-0 top-1  mr-4 cursor-pointer h-full ">
                  <svg
                    className="text-gray-600 h-4 w-4 fill-current mt-[10px]"
          ...
          <div
            className="overlay fixed top-0 left-0 right-0 bottom-0 bg-[rgb(0,0,0,0.3)]  z-20"
        ...
        <div className="  flex justify-between h-full max-w-[1185px]  lg:m-auto ">
          <div className="mb-[20px] hidden max-md:block my-[10px]">
            ...
            <div className="mobile-filter z-10 fixed top-0 left-0 bottom-0 bg-white w-[320px] max-w-[100%] translate-x-[-100%] transition duration-500 ">
              <svg
                ...
                className="w-[20px] absolute right-3 top-2 cursor-pointer"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 352 512"
              >
          ...
          <div className="pt-3   text-gray-600 w-2/4 max-md:hidden relative ml-[100px]">
            <form action="" onSubmit={handleSearchProductByName}>
              <input
                className="border-2h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none w-full"
                type="search"
                id="search"
                name="search"
                placeholder="Search"
          ...
          <div className=" justify-end gap-[20px] w-[80px] text-center">
            
            <div className="text-white leading-[60px]"><span className="cursor-pointer" onClick={()=>navigate("listProduct")} >Sản phẩm</span></div>
          </div>
          <div className="flex gap-4 ">
            <button
              type="button"
              id="icon_search_moblie"
              onClick={handleToggleSearchMobile}
              className=" max-md:block hidden"
            >
              <svg
                className="text-white h-5  fill-current w-[30px]"
                xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink"
                version="1.1"
                id="Capa_1"
      ...
      <footer className="bg-[#1D1D1F] text-white lg:px-[146px] max-md:grid-cols-2 grid max-lg:grid-cols-5  lg:grid-cols-5 pt-[64px] gap-[50px] mt-[200px]">
        <div className="md:col-span-2 max-md:col-span-2 max-md:px-[10px]">
          ...
          <div className="flex">
            ...
            <div className="w-[56px]">
              <img
                src="https://shopdunk.com/Themes/SD/Content/images/Youtube.png"
                alt=""
              />
            </div>
            <div className="w-[56px]">
              <img
                src="https://shopdunk.com/Themes/SD/Content/images/Zalo.png"
                alt=""
              />
            </div>
          </div>
        ...
        <div>
          ...
          <ul>
            <li className="text-[13px] text-[#86868B] leading-[28px]">
              Tin tức
            </li>
            <li className="text-[13px] text-[#86868B] leading-[28px]">
              Giới thiệu
